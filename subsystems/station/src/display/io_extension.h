 ...
 * | Info         :   Ported from pendant2 drivers/io_extension.h
 ******************************************************************************/
...
#define IO_EXTENSION_IO_3          0x03  // LCD reset
#define IO_EXTENSION_IO_4          0x04  // SD card CS
#define IO_EXTENSION_IO_5          0x05  // USB/CAN select: 0=USB, 1=CAN
